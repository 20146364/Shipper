...
public class ThemDonHang extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    SharedPreferences sharedPreferences;
        ...
        private static final String LOG_TAG = "ThemDonHang";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AutoCompleteTextView etVTN = (AutoCompleteTextView) findViewById(R.id.etVTN);
        final AutoCompleteTextView etVTD = (AutoCompleteTextView) findViewById(R.id.etVTD);
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Update_Order registerRequest = new Update_Order( sotk, mota, vtn, vtd,  time, responseListener);
